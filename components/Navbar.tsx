    ...
    <header className="flex items-center justify-between border-b border-[#f0f2f4] bg-white px-6 py-3 z-50 sticky top-0 backdrop-blur-md bg-white/90">
      ...
      <div className="flex flex-1 justify-end gap-6 items-center">
        <nav className="hidden md:flex items-center gap-8 mr-6">
          ...
          <a href="#services" className="text-sm font-semibold text-secondary hover:text-primary transition-colors">Services</a>
          <button className="text-sm font-semibold text-secondary hover:text-primary transition-colors">About Us</button>
          <button 
